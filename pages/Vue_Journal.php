              ...
              <form action="<?php echo site_url(); ?>journal/ajoutJournal" method="post" class="">
                    ...
                    <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    <tbody id="line-container">
                                        <tr  id="tbody">
                                            ...
                                            <td><input type="text"  name="insert[]" placeholder="num" class="form-control clear"></td>
                                            <td><input type="Text"  name="nom[]" placeholder="nom Tiers" class="form-control clear"></td>
                                            <td><input type="Text"  name="cause[]" placeholder="nom Tiers" class="form-control clear"></td>
                                            <th><input type="number"  name="montant[]" placeholder="montant "id="montant" class="form-control calcul"></th>
                                            <td><input type="number"  name="debit[]" placeholder="debit" class="form-control" id="debit_mont" oninput=" valider()"></td>
                                            <td><input type="number"  name="credit[]" placeholder="credit" class="form-control" id="credit_mont" oninput=" valider()"></td>
                                        </tr>
                            ...
                            <div class="form-actions form-group" >
                                ...
                                <button type="submit" class="btn btn-secondary btn-sm" id="btn1" style="display:none;">Ajout</button>
                            </div>
