<?php 
    ...
    class Balance extends CI_Model {
        ...
        public function listeResultat($idEntreprise, $idExercice) {
            ...
            $tab[] = $this->TVAverse($idEntreprise, $idExercice);
        ...
        public function TVAverse($idEntreprise, $idExercice) {
            $this->load->model('Compte');
            $requette = "SELECT CASE " .
                            "WHEN SUM(tab.soldeDebiteur)::integer !=0 THEN SUM(tab.soldeDebiteur)::integer
                                ELSE 0 
            ...
            return  new Balance("" . $idEntreprise, "4458", "TVA a verser", "" . $idExercice , "" . $liste[0]['soldedebiteur'], "" . $liste[0]['soldecrediteur'], "" .  $deductible, "" . $collecte);
        }
    }
?>